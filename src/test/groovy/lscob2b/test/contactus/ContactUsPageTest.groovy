...
class ContactUsPageTest extends PropertProviderTest{
	...
	def "Verify contact us page fields"() {
		...
		assert titleLabel.text()==expectedValue("user.title")
		assert firstNameLabel.text()==expectedValue("user.firstName")
		assert lastNameLabel.text()==expectedValue("user.lastName")
		assert emailLabel.text()==expectedValue("user.email")
		assert phoneLabel.text()==expectedValue("user.phone")
		assert companyNameLabel.text()==expectedValue("user.companyName")
		assert customerNumberLabel.text()==expectedValue("user.customerNumber")
		assert countryLabel.text()==expectedValue("user.country")
		//assert commentsLabel.text()==expectedValue("user.comments")
