...
export SELENIUM_PLATFORM="windows"
...
mvn clean test-compile test -DargLine="-Dgeb.sauce.browser=1 -Dgeb.sauce.user=simone-romei -Dgeb.sauce.access.key=6654f839-e7e6-4263-b5e7-7980eefb4b42"
